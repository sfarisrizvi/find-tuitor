    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--surface)' }}>
      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          ...
          <div style={{ fontWeight: 600, color: 'var(--ink)', display: 'flex', alignItems: 'center', gap: '8px', marginRight: '12px' }}>
          ...
          <Button 
            ...
            style={{ display: 'none' /* Will be toggled by css media query later if needed, but flex wrap helps for now */ }}
          >
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center', maxWidth: '400px' }}>
                ...
                <h3 style={{ fontSize: '24px', fontWeight: 700, color: 'var(--ink)', marginBottom: '12px' }}>
                  {tutors.length - 3} more tutors available
                </h3>
