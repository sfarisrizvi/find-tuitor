...
export function AuthSidebar() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: '-10%', left: '-10%', width: '350px', height: '350px', borderRadius: '50%', background: 'rgba(255,255,255,0.03)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '-10%', right: '-10%', width: '450px', height: '450px', borderRadius: '50%', background: 'rgba(255,255,255,0.03)', pointerEvents: 'none' }} />
      
      <div style={{ maxWidth: '480px', textAlign: 'center', zIndex: 10 }}>
        {/* Lottie Animation Container */}
        <div ref={containerRef} style={{ width: '100%', height: '320px', margin: '0 auto 30px' }} />
        
        <h2 style={{ fontSize: '28px', fontWeight: 800, margin: '0 0 16px 0', color: '#fff', letterSpacing: '-0.5px' }}>
          Connect with Expert Tutors
        </h2>
        <p style={{ fontSize: '16px', color: 'rgba(255, 255, 255, 0.85)', lineHeight: 1.6, margin: 0 }}>
