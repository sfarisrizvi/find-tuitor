      ...
      <div style={{
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '2px' }}>
            <Link href="/forgot-password" style={{ fontSize: '13px', color: 'var(--ink)', fontWeight: 600 }}>
              Forgot Password?
            </Link>
          </div>
          ...
          {/* Social Sign Ins (Only full-width Google button) */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '16px', position: 'relative' }}>
            {/* Google Button */}
            <button
              type="button"
